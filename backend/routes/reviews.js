...
// Admin routes - must come before the generic :review_id route
router.get('/admin', reviewController.getAllReviewsForAdmin);
router.get('/admin/:review_id', reviewController.getReviewForAdmin);
router.delete('/admin/:review_id', reviewController.softDeleteReview);
router.patch('/admin/restore/:review_id', reviewController.restoreReview);
